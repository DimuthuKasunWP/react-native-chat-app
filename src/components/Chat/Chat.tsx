...
export interface ChatProps<TMessage extends IMessage = IMessage> {
  /* Messages to display */
  messages?: TMessage[]
...
export interface ChatState<TMessage extends IMessage = IMessage> {
...
class Chat<TMessage extends IMessage = IMessage> extends React.Component<
  ChatProps<TMessage>,
  ChatState
> {
  ...
  constructor(props: ChatProps<TMessage>) {
    super(props)
  ...
  componentDidUpdate(prevProps: ChatProps<TMessage> = {}) {
